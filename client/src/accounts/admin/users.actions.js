...
export const createUser = fields => async dispatch => {
  ...
  const data = {
    name: fields['case-file-name'],
    description: fields['case-file-description']
  };

  try {
    const response = await sendData(API, data, JSON_HEADERS);
    ...
    return dispatch({ type: CREATE_USER_REQUESTED_FAILURE, error });
  }
};
...
export const fetchUsers = () => async dispatch => {
  ...
  try {
    ...
    return dispatch({ type: USERS_REQUESTED_FAILURE, error });
  }
};

export const updateUser = user => async dispatch => {
  console.log('U#PDATING: ', user);
  ...
  try {
    ...
    return dispatch({ type: UPDATE_USER_REQUESTED_FAILURE, error });
  }
};
...
export const deleteUser = id => async dispatch => {
  ...
  try {
    ...
    return dispatch({ type: DELETE_USER_REQUESTED_FAILURE, error });
  }
};
